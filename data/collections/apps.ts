export const apps = [
 {
  ...
  description: "Apps for social media.",
  color: "var(--blue-500)",
  appList: [
   {
    name: "Twitter",
 ...
 {
  category: "Music",
  description: "Apps for listening to music and following artists.",
  color: "var(--red-500)",
  appList: [
   {
    name: "Apple Music",
 ...
 {
  category: "Streaming",
  description: "Apps for streaming media.",
 ...
 {
  category: "Fitness",
  description: "Apps for tracking fitness activities.",
  color: "var(--green-500)",
  appList: [
   {
    name: "AutoSleep",
 ...
 {
  category: "Games",
  description: "I'm not much of a mobile gamer, but there is a time and a place for it.",
 ...
 {
  category: "Reference",
  description: "Apps for looking up information.",
 ...
 {
  category: "Travel",
  description: "Apps for traveling.",
  color: "var(--pink-500)",
  appList: [
   {
    name: "Flighty",
 ...
 {
  category: "Work",
  description: "Apps I use primarily for work.",
  color: "var(--blue-500)",
  appList: [
   {
    name: "GitHub",
 ...
 {
  category: "Finance",
  description: "Apps for managing my cash.",
  color: "var(--gray-500)",
  appList: [
   {
    name: "BankID",
    description: "Government login service.",
    url: "https://apps.apple.com/us/app/bankid/id1481000013",
   },
   {
    name: "Vipps",
    description: "Mobile payment.",
    url: "https://apps.apple.com/us/app/vipps/id1481000014",
   },
  ],
 },
]